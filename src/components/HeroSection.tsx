...
export default function HeroSection() {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden px-4 sm:px-6 lg:px-8">
      ...
      <motion.div
        className="absolute top-20 right-20 w-20 h-20 border-2 border-cyan-500/30 rotate-45"
        animate={{
          rotate: [45, 225, 45],
          scale: [1, 1.2, 1],
        }}
      ...
      />
      <motion.div
        className="absolute bottom-32 left-16 w-16 h-16 border-2 border-purple-500/30 rounded-full"
        animate={{
          scale: [1, 1.3, 1],
          opacity: [0.3, 0.6, 0.3],
        }}
      ...
      />
      <motion.div
        className="absolute top-40 left-32 w-12 h-12 bg-gradient-to-r from-pink-500/20 to-cyan-500/20 rounded-lg"
        animate={{
          rotate: [0, 360],
          y: [0, -20, 0],
        }}
      ...
      >
        ...
        <motion.div variants={itemVariants} className="mb-8">
          <motion.div
            className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass-custom text-sm"
        ...
        <motion.p
          variants={itemVariants}
          className="text-xl sm:text-2xl md:text-3xl text-muted-foreground mb-8 max-w-3xl mx-auto leading-relaxed"
        >
        ...
        >
          ...
          <GradientButton variant="outline" size="lg" className="!text-white !border-white/20 hover:!border-cyan-500/50">
        ...
        >
          {[
            ...
            <motion.div
              key={index}
              className="glass-custom rounded-2xl p-6 text-center"
              whileHover={{
                scale: 1.05,
                y: -10,
              }}
            ...
            >
              <motion.div
                className={`w-16 h-16 mx-auto mb-4 rounded-2xl bg-gradient-to-br ${feature.gradient} flex items-center justify-center`}
